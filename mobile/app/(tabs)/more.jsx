  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        color: '#dc2626',
        title: 'Fraud & Risk',
        desc: 'Suspicious activity alerts',
        route: '/(tabs)/fraud',
      },
      {
        ...
        color: '#2563eb',
        title: 'Rostering',
        desc: 'Staff shift schedule',
        route: '/(tabs)/rostering',
      },
      {
        icon: 'color-wand',
        color: '#db2777',
        title: 'Festival Mode',
        desc: 'Surge & festival configs',
        route: '/(tabs)/festival',
      },
      {
        icon: 'pricetags',
        ...
        desc: 'Time & demand pricing',
        route: '/(tabs)/dynamic-pricing',
      },
      {
        icon: 'swap-horizontal',
        color: '#059669',
        title: 'Settlements',
        desc: 'Payouts & settlements',
        route: '/(tabs)/settlements',
      },
    ],
  },
];
