...
export const FEATURES = [
  ...
  { slug: 'online-orders', name: 'Online Orders & Aggregators', icon: 'bag', group: 'Growth',
    blurb: 'Uber Eats, DoorDash & Menulog in one screen — plus your own commission-free QR ordering.' },
  { slug: 'accounting', name: 'Accounting & Compliance', icon: 'ledger', group: 'Back office',
    blurb: 'GST & BAS lodgement, Xero and MYOB sync, and Single Touch Payroll — automatic and ATO-ready.' },
...
export const CASE_STUDIES = [
  { region: 'au', name: 'Harbour & Vine', type: 'Multi-outlet · Melbourne',
    summary: 'Consolidated POS, Uber Eats & DoorDash and books into one system across 3 venues.',
  ...
  { region: 'au', name: 'Rapid Roll', type: 'QSR · Brisbane',
...
<p>MSRM does steps 1–5 automatically — recipes, variance, reorder alerts, menu analytics and one-click EOD.</p>` },
  {
    slug: 'aggregator-commissions-australia', title: 'Uber Eats vs DoorDash: the delivery numbers to actually track', tag: 'Delivery', date: '2026-05-20',
    excerpt: 'Aggregators bring volume but take a big cut. Track net-per-channel, not gross, to know what’s really working.',
    body: `<p>Delivery aggregators can run 30–35% in commission once you add packaging and promoted listings. The mistake most owners make is celebrating gross delivery sales while ignoring what lands in the bank.</p>
<h2>Track net, per channel</h2><p>The number that matters is <strong>net revenue after commission</strong> for each platform. A channel doing high gross at 35% commission may make you less than a smaller one at 20%.</p>
...
<p>MSRM’s channel analytics shows gross, commission and net side by side, supports per-channel pricing, and auto-86s items everywhere at once.</p>` },
  {
    ...
    excerpt: 'Changing POS feels risky when Uber Eats, DoorDash or Menulog run through it. Here’s how to switch with zero downtime.',
...
<h2>Keep aggregators live through cutover</h2><p>Your Uber Eats, DoorDash and Menulog links should stay active and only move at cutover, outlet by outlet.</p>
