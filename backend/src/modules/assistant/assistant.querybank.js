...
const CORES = {
  ...
  fraud_alerts: [
    ...
    'risky staff behaviour', 'anything flagged for review', 'open fraud cases', 'suspicious refund patterns',
    'any anomalies flagged', 'fraud alerts summary', 'is anyone abusing discounts', 'unusual activity alerts',
    'what fraud alerts are open', 'any suspicious cancellations', 'staff risk alerts', 'shrinkage alerts',
  ],
  staff_hours: [
